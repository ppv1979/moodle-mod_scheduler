...
<p><ul>
<li><b>Режим «Одна встреча за раз»:</b>Студент может записаться только на одну (будущую) дату. После того как встреча прошла, он может записаться снова. Этот режим подходит для назначения встреч по долгосрочным проектам, особенно когда необходимы несколько встреч на разных этапах проекта. </li>
<li><b> Режим «<em>n</em> встреч за раз»:</b> Студент может записаться на определенное количество встреч. После того как встреча прошла и преподаватель поставил отметку, что студент присутствовал на ней, студент сможет записаться на другие встречи. Тем не менее, студент в любой момент времени ограничен <em>n</em> «открытыми» (несостоявшимися) встречами. 
</li>
</ul>
</p>';
...
$string['reuse_help']='
<i>Используемый повторно</i> интервал будет оставаться в расписании, даже если студент или учитель отменили встречу. Освободившийся интервал будет снова доступен для записи.</p>
